...
const generateEmailContent = (data: any) => {
  ...
  <h3 class="form-heading" align="left">${
    CONTACT_MESSAGE_FIELDS.instagram
  }</h3><p class="form-answer" align="left">${data.instagram}</p>

  ${
    data.website
      ? `<h3 class="form-heading" align="left">${CONTACT_MESSAGE_FIELDS.website}</h3><p class="form-answer" align="left">${data.website}</p>`
      : ""
  }
   ${
     data.twitter
